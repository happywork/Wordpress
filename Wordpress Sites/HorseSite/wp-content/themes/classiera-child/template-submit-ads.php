	...
	if(trim($_POST['postTitle']) != '' && $_POST['classiera-main-cat-field'] != ''){		
		if(isset($_POST['submitted']) && isset($_POST['post_nonce_field']) && wp_verify_nonce($_POST['post_nonce_field'], 'post_nonce')) {
			...
			if($hasError != true && !empty($_POST['classiera_post_type']) || isset($_POST['regular-ads-enable'])) {
				...
				update_post_meta($post_id, 'hp_discipline', $_POST['hp_discipline'], $allowed);
				update_post_meta($post_id, 'saddle_type', $_POST['saddle_type'], $allowed);
				update_post_meta($post_id, 'saddle_size', $_POST['saddle_size'], $allowed);
				//Custom Multi checkbox//
						...
						<div class="form-main-section post-detail">
							...
							<div class="form-group">
								<label class="col-sm-3 text-left flip">
									<?php esc_html_e('Horses & Ponies/Discipline', 'classiera') ?> :
								</label>
								<div class="col-sm-9">
									<div class="form-inline row">
										<div class="col-sm-12">
											<div class="checkbox checkbox_cava">
												<!--All Rounder-->
												<input type="checkbox" name="hp_discipline[]" value="All Rounder" id="rounder">
												<label for="rounder">All Rounder</label>
												<!--Breeding-->
												<input type="checkbox" name="hp_discipline[]" value="Breeding" id="Breeding">
												<label for="Breeding">Breeding</label>
												<!--Camp-->
												<input type="checkbox" name="hp_discipline[]" value="Camp" id="Camp">
												<label for="Camp">Camp</label>
												<!--Drafting-->
												<input type="checkbox" name="hp_discipline[]" value="Drafting" id="Drafting">
												<label for="Drafting">Drafting</label>
												<!--Companion-->
												<input type="checkbox" name="hp_discipline[]" value="Companion" id="Companion">
												<label for="Companion">Companion</label>
												<!--Cutting-->
												<input type="checkbox" name="hp_discipline[]" value="Cutting" id="Cutting">
												<label for="Cutting">Cutting</label>
												<!--Dressage-->
												<input type="checkbox" name="hp_discipline[]" value="Dressage" id="Discipline_Dressage">
												<label for="Discipline_Dressage">Dressage</label>
												<!--Driving-->
												<input type="checkbox" name="hp_discipline[]" value="Driving" id="Driving">
												<label for="Driving">Driving</label>
												<!--Endurance-->
												<input type="checkbox" name="hp_discipline[]" value="Endurance" id="disciplineEndurance">
												<label for="disciplineEndurance">Endurance</label>
												<!--Eventing-->
												<input type="checkbox" name="hp_discipline[]" value="Eventing" id="Eventing">
												<label for="Eventing">Eventing</label>
												<!--inhand-->
												<input type="checkbox" name="hp_discipline[]" value="In Hand" id="inhand">
												<label for="inhand">In Hand</label>
												<!--Natural-->
												<input type="checkbox" name="hp_discipline[]" value="Natural" id="Natural">
												<label for="Natural">Natural</label>
												<!--Horsemanship-->
												<input type="checkbox" name="hp_discipline[]" value="Horsemanship" id="hrship">
												<label for="hrship">Horsemanship</label>
												<!--Novelties-->
												<input type="checkbox" name="hp_discipline[]" value="Novelties" id="Novelties">
												<label for="Novelties">Novelties</label>
												<!--Pacing-->
												<input type="checkbox" name="hp_discipline[]" value="Pacing" id="Pacing">
												<label for="Pacing">Pacing</label>
												<!--PC/ARC-->
												<input type="checkbox" name="hp_discipline[]" value="PC/ARC" id="pc-arc">
												<label for="pc-arc">PC/ARC</label>
												<!--Pleasure/Bush Hack-->
												<input type="checkbox" name="hp_discipline[]" value="Pleasure/Bush Hack" id="Pleasure">
												<label for="Pleasure">Pleasure/Bush Hack</label>
												<!--Polo-->
												<input type="checkbox" name="hp_discipline[]" value="Polo" id="Polo">
												<label for="Polo">Polo</label>
												<!--Polocrosse-->
												<input type="checkbox" name="hp_discipline[]" value="Polocrosse" id="Polocrosse">
												<label for="Polocrosse">Polocrosse</label>
												<!--Racing-->
												<input type="checkbox" name="hp_discipline[]" value="Racing" id="disciplineRacing">
												<label for="disciplineRacing">Racing</label>
												<!--Reining-->
												<input type="checkbox" name="hp_discipline[]" value="Reining" id="Reining">
												<label for="Reining">Reining</label>
												<!--Show Jumping-->
												<input type="checkbox" name="hp_discipline[]" value="Show Jumping" id="showJumping">
												<label for="showJumping">Show Jumping</label>
												<!--Show Horse-->
												<input type="checkbox" name="hp_discipline[]" value="Show Horse" id="ShowHorse">
												<label for="ShowHorse">Show Horse</label>
												<!--Stockhorse-->
												<input type="checkbox" name="hp_discipline[]" value="Stockhorse" id="Stockhorse">
												<label for="Stockhorse">Stockhorse</label>
												<!--Western-->
												<input type="checkbox" name="hp_discipline[]" value="Western" id="disciplineWestern">
												<label for="disciplineWestern">Western</label>
												<!--Working Horse-->
												<input type="checkbox" name="hp_discipline[]" value="Working Horse" id="WorkingHorse">
												<label for="WorkingHorse">Working Horse</label>
												<!--Off the Track-->
												<input type="checkbox" name="hp_discipline[]" value="Off the Track" id="OfftheTrack">
												<label for="OfftheTrack">Off the Track</label>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="form-group">
								<label class="col-sm-3 text-left flip">
									<?php esc_html_e('Second Hand Saddlery/Saddle Type', 'classiera') ?> :
								</label>
								<div class="col-sm-9">
									<div class="form-inline row">
										<div class="col-sm-12">
											<div class="checkbox checkbox_cava">
												<!--Endurance-->
												<input type="checkbox" name="saddle_type[]" value="Endurance" id="Endurance">
												<label for="Endurance">Endurance</label>
												<!--Western-->
												<input type="checkbox" name="saddle_type[]" value="Western" id="Western">
												<label for="Western">Western</label>
												<!--All Purpose-->
												<input type="checkbox" name="saddle_type[]" value="All Purpose" id="AllPurpose">
												<label for="AllPurpose">All Purpose</label>
												<!--Dressage-->
												<input type="checkbox" name="saddle_type[]" value="Dressage" id="Dressage">
												<label for="Dressage">Dressage</label>
												<!--Jumping-->
												<input type="checkbox" name="saddle_type[]" value="Jumping" id="Jumping">
												<label for="Jumping">Jumping</label>
												<!--Show-->
												<input type="checkbox" name="saddle_type[]" value="Show" id="saddleShow">
												<label for="saddleShow">Show</label>
												<!--Stock-->
												<input type="checkbox" name="saddle_type[]" value="Stock" id="Stock">
												<label for="Stock">Stock</label>
												<!--Side Saddle-->
												<input type="checkbox" name="saddle_type[]" value="Side Saddle" id="SideSaddle">
												<label for="SideSaddle">Side Saddle</label>
												<!--Racing-->
												<input type="checkbox" name="saddle_type[]" value="Racing" id="Racing">
												<label for="Racing">Racing</label>
												<!--Treeless-->
												<input type="checkbox" name="saddle_type[]" value="Treeless" id="Treeless">
												<label for="Treeless">Treeless</label>
												<!--Halfbreed-->
												<input type="checkbox" name="saddle_type[]" value="Halfbreed" id="Halfbreed">
												<label for="Halfbreed">Halfbreed</label>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="form-group">
								<label class="col-sm-3 text-left flip">
									<?php esc_html_e('Second Hand Saddlery/Saddle Size', 'classiera') ?> :
								</label>
								<div class="col-sm-9">
									<div class="form-inline row">
										<div class="col-sm-12">
											<div class="checkbox checkbox_cava">
												<input type="checkbox" name="saddle_size[]" value="12-13 inch" id="12inch">
												<label for="12inch">12-13 inch</label>
												<input type="checkbox" name="saddle_size[]" value="14-15 inch" id="14inch">
												<label for="14inch">14-15 inch</label>
												<input type="checkbox" name="saddle_size[]" value="15-16 inch" id="16inch">
												<label for="16inch">15-16 inch</label>
												<input type="checkbox" name="saddle_size[]" value="16-17 inch" id="17inch">
												<label for="17inch">16-17 inch</label>
												<input type="checkbox" name="saddle_size[]" value="17-18 inch" id="18inch">
												<label for="18inch">17-18 inch</label>
												<input type="checkbox" name="saddle_size[]" value="18-19 inch" id="19inch">
												<label for="19inch">18-19 inch</label>
											</div>
										</div>
									</div>
								</div>
