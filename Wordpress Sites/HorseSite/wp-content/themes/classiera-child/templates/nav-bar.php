<?php 
    ...
    if($classieraNavStyle == 1){
        $container = 'container';
        $classieraSecClass = 'classiera-navbar-cava';
        $classieraNavClass = 'classiera-custom-navbar-cava';
...
?>
<!-- NavBar -->
<section class="classiera-navbar  <?php echo $affixClass;?> <?php echo $classieraSecClass; ?>">
    ...
    <nav id="myNavmenu" class="navmenu navmenu-default offcanvas offcanvas-light <?php if(is_rtl()){echo " navmenu-fixed-right ";}else{ echo "navmenu-fixed-left "; } ?>" role="navigation">
        ...
        <div class="submit-post">
            <a <?php if(!is_user_logged_in()): ?> data-toggle="modal" data-target="#logIn" href="#" <?php else: ?> href="<?php echo $classieraSubmitPost; ?>" <?php endif; ?> class="btn btn-block btn-primary btn-md active">
        ...
        <div class="social-network">
            <h5>
                <?php esc_html_e( 'Social network', 'classiera' ); ?>
            </h5>
            <!--FacebookLink-->
    ...
    <div class="<?php echo $container; ?>">        
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <nav id="myNavmenu" class="navmenu navmenu-default navmenu-fixed-left offcanvas offcanvas-light <?php if(is_rtl()){echo " navmenu-fixed-right ";}else{ echo "navmenu-fixed-left "; } ?> <?php echo $offcanvasDark; ?>" role="navigation">
                    <div class="navmenu-brand clearfix">
                        <a href="<?php echo home_url(); ?>">
                            <?php if(empty($classieraLogo)){?>
                            <img src="<?php echo get_template_directory_uri(); ?>/images/logo.png" alt="<?php bloginfo( 'name' ); ?>">
                ...
                <nav class="navbar navbar-default <?php echo $classieraNavClass; ?>">
                    ...
                    <div class="collapse navbar-collapse visible-lg" id="navbarCollapse">
                        ...
                        <div class="nav navbar-nav navbar-right betube-search flip">
                            <a <?php if(!is_user_logged_in()): ?> data-toggle="modal" data-target="#logIn" href="#" <?php else: ?> href="<?php echo $classieraSubmitPost; ?>" <?php endif; ?> class="btn btn-primary radius btn-md btn-style-three active">
                                <?php esc_html_e( 'Place An Ad', 'classiera' ); ?>
                            </a>
                        </div>
                        <?php }elseif($classieraNavStyle == 4){ ?>
                        <div class="nav navbar-nav navbar-right betube-search flip">
                            <a <?php if(!is_user_logged_in()): ?> data-toggle="modal" data-target="#logIn" href="#" <?php else: ?> href="<?php echo $classieraSubmitPost; ?>" <?php endif; ?> class="btn btn-primary radius btn-md btn-style-four active">
                                <?php esc_html_e( 'Place An Ad', 'classiera' ); ?>
                            </a>
                        </div>
                        ...
                        <div class="custom-menu-v5">
                            ...
                            <div class="navbar-right login-reg flip">
                                ...
                                <a href="<?php echo $classieraProfileURL; ?>">
                                    <?php esc_html_e( 'My Account', 'classiera' ); ?> <i class="zmdi zmdi-account"></i></a>
                                <?php }else{ ?>
                                <a href="<?php echo $classieraLoginURL; ?>">
                                    <?php esc_html_e( 'Login', 'classiera' ); ?> <i class="zmdi zmdi-account"></i></a>
                                <?php } ?>
                                <a <?php if(!is_user_logged_in()): ?> data-toggle="modal" data-target="#logIn" href="#" <?php else: ?> href="<?php echo $classieraSubmitPost; ?>" <?php endif; ?> class="btn btn-primary outline round">
                                    <?php esc_html_e( 'Place An Ad', 'classiera' ); ?>
                                </a>
                            </div>
                            ...
                            <div class="navbar-right login-reg flip">
                                ...
                                <a href="<?php echo $classieraLoginURL; ?>">
                                    <?php esc_html_e( 'Login', 'classiera' ); ?> <i class="zmdi zmdi-account"></i></a>
                                <?php } ?>
                                <a <?php if(!is_user_logged_in()): ?> data-toggle="modal" data-target="#logIn" href="#" <?php else: ?> href="<?php echo $classieraSubmitPost; ?>" <?php endif; ?> class="btn btn-primary outline radius">
                                    <?php esc_html_e( 'Place An Ad', 'classiera' ); ?>
                                </a>
                            </div>
                            <?php } ?>
                            ...
                            <div class="navbar-right login-reg flip">
                                ...
                                <?php }else{ ?>
                                <a href="#" data-toggle="modal" data-target="#logIn" class="lr-with-icon">
                                    <i class="zmdi zmdi-lock"></i><?php esc_html_e( 'Login', 'classiera' ); ?>
                                </a>
                                <a href="#" data-toggle="modal" data-target="#joinNow" class="lr-with-icon">
                                    <i class="zmdi zmdi-border-color"></i><?php esc_html_e( 'Get Registered', 'classiera' ); ?>
                                </a>
                                <?php } ?>
                                <a <?php if(!is_user_logged_in()): ?> data-toggle="modal" data-target="#logIn" href="#" <?php else: ?> href="<?php echo $classieraSubmitPost; ?>" <?php endif; ?> class="btn btn-primary btn-submit active">
                                    <?php esc_html_e( 'Place An Ad', 'classiera' ); ?>
                                </a>
                            </div>
                        </div>
