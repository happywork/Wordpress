...
<!--								<i class="form-icon form-icon-size-small left-form-icon zmdi zmdi-border-color"></i>-->
								<input type="text" id="classieraSearchAJax" name="s" class="form-control form-control-lg" placeholder="<?php esc_html_e( 'I\'m looking for...', 'classiera' ); ?>" data-error="<?php esc_html_e( 'Please Type some words..!', 'classiera' ); ?>" value="<?php echo get_query_var('s'); ?>">
                               ...
                               <i class="icon select-down"></i>
								...
								<select class="form-control form-control-lg" data-placeholder="<?php esc_html_e('Select Category..', 'classiera'); ?>" name="category_name" id="ajaxSelectCat">
									...
									foreach ($categories as $cat) {
										...
										<option value="<?php echo $cat->slug; ?>" <?php echo (get_query_var('category_name') === $cat->slug) ? 'selected' : ''; ?>><?php echo $cat->cat_name; ?></option>
											<?php
											$args2 = array(
												'hide_empty' => '0',
												'parent' => $catID
