	...
	<div class="container">
		<div class="row">
			<div class="classiera-static-slider-content text-center">
				<h1><?php echo $classieraIMGheaderTitle; ?></h1>
				<h2><?php echo $classieraIMGheaderDesc; ?></h2>
			</div>
		</div>
	</div><!--container-->
		...
		<ul class="list-inline list-unstyled">
			...
			foreach ($categories as $category) {
				...
				if($current <= $classieraCatMenuCount){
					?>
					<li>
						<a class="match-height" href="<?php echo $categoryLink; ?>">
							<?php 
							if($classieraIconsStyle == 'icon'){
								...
								?>
								<img src="<?php echo $classieraCatIcoIMG; ?>">
								<?php
							}
							?>
