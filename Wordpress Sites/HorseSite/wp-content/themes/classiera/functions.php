...
function classiera_ad_expiry() {
	...
	if (!empty($redux_demo['ad_expiry'])){
		...
		WHERE (post_type = 'post' AND post_status = 'publish' AND 'featured_post' ! = 1)
...
function classiera_admin_featuredPlan() {
	...
	$classieraInbox = ("CREATE TABLE IF NOT EXISTS {$wpdb->prefix}classiera_inbox(
		id int(11) NOT NULL AUTO_INCREMENT,
		offer_post_id TEXT ,
		offer_post_price TEXT ,
		post_author_id TEXT ,
		offer_author_id TEXT,
...
?>
	...
	var classieraCurrentUserID = '<?php echo $user_ID; ?>';
	</script>
<?php	
}
/*==========================
...
/*==========================
 Classiera : Remove images when delete post
 @since classiera 1.0
 ===========================*/
add_action('before_delete_post', ' classiera_delete_post_children');
add_action('trash_post', 'classiera_delete_post_children');
function classiera_delete_post_children($post_id){
	global $wpdb;
...
if (!function_exists('classiera_get_template_url')) {
	function classiera_get_template_url(){
		$url;
...
/*==========================
 Classiera : Display Varified Icon
 ===========================*/
...
/*==========================
 Curent User have Unread Message
 ===========================*/
...
/*==========================
 Remove dashicons for non admin
 ===========================*/
