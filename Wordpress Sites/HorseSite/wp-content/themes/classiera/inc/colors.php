...
function classiera_wpcss_head() {
	...
	if(!empty($classieraNavbarTxtColor)){
		...
		echo $classieraNavbarTxtColor;
		echo " !important; } ";
	}
	//Footer Tags Options//
	if(!empty($classieraFooterTagsBG)) {
		echo "footer .widget-box .tagcloud a{ background: ";
		echo $classieraFooterTagsBG;
		echo " !important; } ";
	}
	if(!empty($classieraFooterTagsTxt)) {
		echo "footer .widget-box .tagcloud a{ color: ";
		echo $classieraFooterTagsTxt;
		echo " !important; } ";
	}
	//Footer Tags Options//
	...
	if(!empty($classieraTitleColor)){
		echo ".members-v1 .members-text h2.callout_title, .members-v4 .member-content h1, .members-v4 .member-content ul li{ color: ";
		echo $classieraTitleColor;
		echo " !important; } ";
	...
	section.classiera-static-slider, section.classiera-static-slider-v2, section.classiera-simple-bg-slider{
		...
		background-color:<?php echo $redux_demo['classiera_header_bg']['background-color']; ?> !important;
		background-image:url("<?php echo $redux_demo['classiera_header_bg']['background-image']; ?>");
		background-repeat:<?php echo $redux_demo['classiera_header_bg']['background-repeat']; ?>;
		background-position:<?php echo $redux_demo['classiera_header_bg']['background-position']; ?>;
		background-size:<?php echo $redux_demo['classiera_header_bg']['background-size']; ?>;
		background-attachment:<?php $redux_demo['classiera_header_bg']['background-attachment']; ?>;
		<?php } ?>
	}
	section.classiera-static-slider .classiera-static-slider-content h1, section.classiera-static-slider-v2 .classiera-static-slider-content h1, section.classiera-simple-bg-slider .classiera-simple-bg-slider-content h1{
		color:<?php echo $redux_demo['classiera_banner_heading_typography']['color']; ?>;
		font-size:<?php echo $redux_demo['classiera_banner_heading_typography']['font-size']; ?>;
		font-family:<?php echo $redux_demo['classiera_banner_heading_typography']['font-family']; ?> !important;
		font-weight:<?php echo $redux_demo['classiera_banner_heading_typography']['font-weight']; ?>;
		line-height:<?php echo $redux_demo['classiera_banner_heading_typography']['line-height']; ?>;
		text-align:<?php echo $redux_demo['classiera_banner_heading_typography']['text-align']; ?>;
		letter-spacing:<?php echo $redux_demo['classiera_banner_heading_typography']['letter-spacing']; ?>;
	}
	section.classiera-static-slider .classiera-static-slider-content h2, section.classiera-static-slider-v2 .classiera-static-slider-content h2, section.classiera-simple-bg-slider .classiera-simple-bg-slider-content h4{
		color:<?php echo $redux_demo['classiera_banner_desc_typography']['color']; ?>;
		font-size:<?php echo $redux_demo['classiera_banner_desc_typography']['font-size']; ?>;
		font-family:<?php echo $redux_demo['classiera_banner_desc_typography']['font-family']; ?> !important;
		font-weight:<?php echo $redux_demo['classiera_banner_desc_typography']['font-weight']; ?>;
		line-height:<?php echo $redux_demo['classiera_banner_desc_typography']['line-height']; ?>;
		text-align:<?php echo $redux_demo['classiera_banner_desc_typography']['text-align']; ?>;
		letter-spacing:<?php echo $redux_demo['classiera_banner_desc_typography']['letter-spacing']; ?>;
	}
	<?php
	/*Image Banner Settings*/
	/*Search MAP Setting*/
