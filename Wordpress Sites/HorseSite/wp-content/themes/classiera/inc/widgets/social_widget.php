	...
	function widget( $args, $instance ) {
		...
		<div class="widget-content">
			<div class="social-network">				
					...
					?>
					<?php if($facebook) : ?><a class="social-icon social-icon-sm footer-social" href="<?php echo $classieraFB; ?>" target="_blank"><i class="fa fa-facebook"></i></a><?php endif; ?>					
					<?php if($twitter) : ?><a class="social-icon social-icon-sm footer-social" href="<?php echo $classieraTw; ?>" target="_blank"><i class="fa fa-twitter"></i></a><?php endif; ?>					
					<?php if($pinterest) : ?><a class="social-icon social-icon-sm footer-social" href="<?php echo $classieraPinterest; ?>" target="_blank"><i class="fa fa-pinterest"></i></a><?php endif; ?>					
					<?php if($bloglovin) : ?><a class="social-icon social-icon-sm footer-social" href="<?php echo $classieraFlicker; ?>" target="_blank"><i class="fa fa-flickr"></i></a><?php endif; ?>					
					<?php if($googleplus) : ?><a class="social-icon social-icon-sm footer-social" href="<?php echo $classieraGooglePlus; ?>" target="_blank"><i class="fa fa-google-plus"></i></a><?php endif; ?>
					<?php if($youtube) : ?><a class="social-icon social-icon-sm footer-social" href="<?php echo $classieraYouTube; ?>" target="_blank"><i class="fa fa-youtube-play"></i></a><?php endif; ?>
					<?php if($rss) : ?><a class="social-icon social-icon-sm footer-social" href="<?php echo $classieraVimeo; ?>" target="_blank"><i class="fa fa-vimeo"></i></a><?php endif; ?>
					<?php if($instagram) : ?><a class="social-icon social-icon-sm footer-social" href="<?php echo $classieraInstagram; ?>" target="_blank"><i class="fa fa-instagram"></i></a><?php endif; ?>
