						...
						<form data-toggle="validator" role="form" method="POST" id="primaryPostForm" action="" enctype="multipart/form-data">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="choose-image">
                                        ...
                                        <button class="classiera_verify_btn" data-toggle="modal" data-target="#verifyModal" type="button"> <i class="fa fa-check"></i> <?php esc_html_e( 'Verified your account', 'classiera' ); ?></button>
										<?php } ?>
										<!-- verify profile btn-->
                                    </div>									
                                </div>
							...
							<div class="form-inline row form-inline-margin">
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <input type="tel" id="phone" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Your Phone No', 'classiera' ); ?>" name="phone" value="<?php echo $user_info->phone; ?>">
                                    </div>
                                </div><!--Phone Number-->
								<div class="form-group col-sm-5">
                                    <label for="mobile"><?php esc_html_e( 'Mobile Number', 'classiera' ); ?></label>
                                    <div class="inner-addon">
                                        <input type="tel" id="mobile" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'update your mobile number', 'classiera' ); ?>" name="phone2" value="<?php echo $user_info->phone2; ?>">
                                    </div>
                                </div><!--Mobile Number-->
								<div class="form-group col-sm-5">
                                    <label for="website"><?php esc_html_e( 'Your Website', 'classiera' ); ?></label>
                                    <div class="inner-addon">
                                        <input type="url" id="website" name="website" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'enter your website link', 'classiera' ); ?>" value="<?php echo $user_info->user_url; ?>">
                                    </div>
                                </div><!--Your Website-->
								<div class="form-group col-sm-5">
                                    <label for="email"><?php esc_html_e( 'Your Email', 'classiera' ); ?></label>
                                    <div class="inner-addon">
                                        <input type="text" id="email" name="email" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'enter your email address', 'classiera' ); ?>" value="<?php echo $user_info->user_email; ?>">
							...
							<h4 class="user-detail-section-heading text-uppercase">
								<?php esc_html_e( 'Socail Profile Links', 'classiera' ); ?>
							</h4>
							<div class="form-inline row form-inline-margin">
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <div class="input-group">
                                            <div class="input-group-addon input-group-addon-width-sm"><i class="fa fa fa-facebook"></i></div>
                                            <input type="url" id="facebook" name="facebook" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your facebook url', 'classiera' ); ?>" value="<?php echo $user_info->facebook; ?>">
                                        </div>
                                    </div>
                                </div><!--facebook-->
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <div class="input-group">
                                            <div class="input-group-addon input-group-addon-width-sm"><i class="fa fa fa-twitter"></i></div>
                                            <input type="url" id="twitter" name="twitter" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your twitter url', 'classiera' ); ?>" value="<?php echo $user_info->twitter; ?>">
                                        </div>
                                    </div>
                                </div><!--twitter-->
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <div class="input-group">
                                            <div class="input-group-addon input-group-addon-width-sm"><i class="fa fa fa-google-plus"></i></div>
                                            <input type="url" id="googleplus" name="google-plus" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your Google Plus url', 'classiera' ); ?>" value="<?php echo $user_info->googleplus; ?>">
                                        </div>
                                    </div>
                                </div><!--Google Plus-->
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <div class="input-group">
                                            <div class="input-group-addon input-group-addon-width-sm"><i class="fa fa fa-instagram"></i></div>
                                            <input type="url" id="instagram" name="instagram" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your instagram url', 'classiera' ); ?>" value="<?php echo $user_info->instagram; ?>">
                                        </div>
                                    </div>
                                </div><!--instagram-->
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <div class="input-group">
                                            <div class="input-group-addon input-group-addon-width-sm"><i class="fa fa fa-pinterest-p"></i></div>
                                            <input type="url" id="pinterest" name="pinterest" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your Pinterest url', 'classiera' ); ?>" value="<?php echo $user_info->pinterest; ?>">
                                        </div>
                                    </div>
                                </div><!--pinterest-->
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <div class="input-group">
                                            <div class="input-group-addon input-group-addon-width-sm"><i class="fa fa fa-linkedin"></i></div>
                                            <input type="url" id="linkedin" name="linkedin" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your Linkedin url', 'classiera' ); ?>" value="<?php echo $user_info->linkedin; ?>">
                                        </div>
                                    </div>
                                </div><!--linkedin-->
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <div class="input-group">
                                            <div class="input-group-addon input-group-addon-width-sm"><i class="fa fa fa-vimeo"></i></div>
                                            <input type="url" id="vimeo" name="vimeo" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your vimeo url', 'classiera' ); ?>" value="<?php echo $user_info->vimeo; ?>">
                                        </div>
                                    </div>
                                </div><!--vimeo-->
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <div class="input-group">
                                            <div class="input-group-addon input-group-addon-width-sm"><i class="fa fa fa-youtube"></i></div>
                                            <input type="url" id="youtube" name="youtube" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your YouTube url', 'classiera' ); ?>" value="<?php echo $user_info->youtube; ?>">
                                        </div>
                                    </div>
                                </div><!--youtube-->
							</div><!--form-inline-->
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<p class="text-uppercase text-center">
					<?php esc_html_e('Following these Setps', 'classiera') ?>
				</p>
			</div><!--modal-header-->
