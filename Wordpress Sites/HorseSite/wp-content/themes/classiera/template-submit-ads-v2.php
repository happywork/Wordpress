						...
						<div class="form-main-section post-detail">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="help-block"><strong><?php esc_html_e('Currency sign is already set as', 'classiera') ?>&nbsp;<?php echo $postCurrency; ?>&nbsp;<?php esc_html_e('Please do not use currency sign in price field. Only use numbers ex: 12345', 'classiera') ?></strong></div>
									<?php } ?>
                                </div>
                            </div><!--Ad Price-->
							<?php } ?>
										...
										foreach( $result as $info ){
											...
											<div class="col-md-offset-3 col-sm-4 col-md-2 col-lg-2 end">
												<div class="post-type-box">
													...
													<div class="radio">
														<input id="regularPlan<?php echo $count; ?>" class="classieraGetID" type="radio" name="classiera_post_type" value="classiera_regular_with_plan" data-regular-id="<?php echo $info->id; ?>">
														<label for="regularPlan<?php echo $count; ?>"><?php esc_html_e('Select', 'classiera') ?></label>
													</div><!--radio-->
												</div><!--post-type-box-->
											</div><!--col-md-offset-3-->
											<?php
