...
<section class="blog-post-section section-pad border-bottom">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 center-block">
                    <h1 class="text-capitalize"><?php echo $classieraBlogSecTitle; ?></h1>
    ...
    <div class="view-all text-center">
        <a href="<?php echo $blogPermalink; ?>" class="btn btn-primary round outline btn-style-six"><?php esc_html_e( 'View All Posts', 'classiera' ); ?></a>
    </div>
</section><!-- /.blog post -->
