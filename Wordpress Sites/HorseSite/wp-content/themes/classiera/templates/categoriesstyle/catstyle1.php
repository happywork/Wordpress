					...
					<div class="col-lg-4 col-md-4 col-sm-6 match-height">
						<div class="category-box border">
							<div class="category-heading border-bottom">
								...
								<span class="category-icon-box" style="background-color:<?php echo $iconColor; ?>; color: <?php echo $iconColor; ?>;">
								<?php 
								...
								?>
									<span class="category-icon-box-border" style="background-color:<?php echo $iconColor; ?>;"></span>
								</span>
							</div>
							<div class="category-content">
								...
								<?php 
									...
									foreach($subcategories as $category) {
										...
										?>
										<li>
											<a href="<?php echo $categoryLink; ?>" title="<?php echo $categoryTitle; ?>">
								...
								<div class="view-button">
									<a href="<?php echo get_category_link( $mainID ) ?>" class="btn btn-primary sharp btn-style-one btn-sm"><?php esc_html_e( 'VIEW ALL', 'classiera' ); ?><i class="fa fa-chevron-right icon-right"></i></a>
								</div>
							</div>
						</div>
					</div>
