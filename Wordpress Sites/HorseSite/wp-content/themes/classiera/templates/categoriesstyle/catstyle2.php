				...
				<div class="category-box border">
					...
					<div class="category-content">
								...
								foreach($subcategories as $category) {
									...
									<li>
										<a href="<?php echo $categoryLink; ?>" class="av-2" data-color="<?php echo $iconColor; ?>">
											<i class="fa fa-angle-right"></i><?php echo $categoryTitle; ?>
											<?php if($classieraPostCount == 1){?>
						...
						<div class="view-button text-center">
							<a href="<?php echo get_category_link( $mainID ) ?>"><?php esc_html_e( 'VIEW ALL', 'classiera' ); ?><i class="fa fa-long-arrow-right right-i"></i></a>
