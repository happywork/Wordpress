		...
		<div class="row">
				...
				<div class="category-box">
					<figure>
						<div class="cat-img">
							...
							<span class="cat-icon" style="background: <?php echo $iconColor; ?>;">
								<?php 
						...
						<figcaption>
							...
							<a href="<?php echo $categoryLink; ?>"><?php esc_html_e( 'View All Ads', 'classiera' ); ?> <i class="fa fa-long-arrow-<?php if(is_rtl()){echo "left";}else{echo "right";}?>"></i></a>
						</figcaption>
					</figure>
				</div>
			</div>			
			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="view-all text-center">
					<a href="<?php echo $allCatURL; ?>" class="btn btn-primary radius outline btn-style-six"><?php esc_html_e( 'View All Categories', 'classiera' ); ?></a>
				</div>
			</div>
		</div>
	</div>
