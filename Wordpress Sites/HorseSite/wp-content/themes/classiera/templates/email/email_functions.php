...
/*==========================
 Email template New User Registration Function
 ===========================*/
function classieraUserEmailVerification($email, $username, $code){
	$blog_title = get_bloginfo('name');
	$blog_url = esc_url( home_url() ) ;
	$adminEmail =  get_bloginfo('admin_email');
	global $redux_demo;
	...
	<div class="classiera-email-content" style="padding: 50px 0; width:600px; margin:0 auto;">
		...
		<p>
			<span style="font-family: 'Ubuntu', sans-serif; font-size: 14px; color: #232323;"><?php esc_html_e( 'Your verification email code is', 'classiera' ); ?> : </span>
			<span style="font-family: 'Ubuntu', sans-serif; font-size: 14px; color: #0d7cb0;"><?php echo $code ?></span>
		</p>
		<p style="font-size: 16px; font-family: 'Lato', sans-serif; color: #6c6c6c;">
			<?php esc_html_e( 'We hope you enjoy your stay at', 'classiera' ); ?> <a href="<?php echo $blog_url; ?>"><?php echo $blog_title; ?></a>. <?php esc_html_e( 'If you have any problems, questions, opinions, praise, comments, suggestions, please feel free to contact us at', 'classiera' ); ?> 
		 <strong><?php echo $adminEmail; ?> </strong><?php esc_html_e( 'any time!', 'classiera' ); ?>
...
/*==========================
 ...
 ===========================*/	
function classiera_reset_password($new_password, $userName, $userEmail, $hash=''){
	$blog_title = get_bloginfo('name');
	$blog_url = esc_url( home_url() ) ;
	$emailTo = $userEmail;
	$adminEmail =  get_bloginfo('admin_email');
	...
	<div class="classiera-email-content" style="padding: 50px 0; width:600px; margin:0 auto;">
        ...
        <p>
			<span style="font-family: 'Ubuntu', sans-serif; font-size: 14px; color: #232323;"><?php esc_html_e( 'To change the password you can follow the link', 'classiera' ); ?> </span>
			<a href="<?php echo $blog_url . '/change-password/?h=' . $hash; ?>" style="font-family: 'Ubuntu', sans-serif; font-size: 14px; color: #0d7cb0;">here</a>
            <span style="font-family: 'Ubuntu', sans-serif; font-size: 14px; color: #232323;"><?php esc_html_e( '(Note: you will be automatically authenticated)', 'classiera' ); ?> </span>
		</p>
	</div>
	<?php
	include(get_template_directory() . '/templates/email/email-footer.php');
...
function classiera_send_offer_to_author($offer_price, $offer_comment, $offer_post_id, $post_author_id, $offer_author_id, $offer_post_price){
	...
	$message = ob_get_contents();
	ob_end_clean();
	wp_mail($authorEmail, $email_subject, $message);
}	
/*==========================
	Report Ad to Admin
 ===========================*/
...
function classiera_contact_us_page($name, $email, $submitMobile, $emailTo, $subject, $comments){
	...
	<div class="classiera-email-content" style="padding: 50px 0; width:600px; margin:0 auto;">
		...
		<p>
			<span style="font-family: 'Ubuntu', sans-serif; font-size: 14px; color: #232323;">
				<?php esc_html_e( 'Sender Name', 'classiera' ); ?> : <?php echo $name; ?>
			</span>
			<span style="font-family: 'Ubuntu', sans-serif; font-size: 14px; color: #0d7cb0;">
				<?php esc_html_e( 'Sender Email', 'classiera' ); ?> : <?php echo $email; ?>
			</span>
			<span style="font-family: 'Ubuntu', sans-serif; font-size: 14px; color: #0d7cb0;">
				<?php esc_html_e( 'Sender Phone', 'classiera' ); ?> : <?php echo $submitMobile; ?>
			</span>
		</p>		
	</div>
	<?php
