				...
				<div class="col-lg-3 col-md-3 col-sm-6 match-height price-plan-v2">
					<div class="pricing-plan-box border <?php if($popular_plan == 'true'){echo "popular";} ?>">
						...
						<div class="pricing-plan-heading text-center clearfix">
							...
							<?php 
								if($free_plans == 1){
									$freeDays = esc_html__('For Life Time', 'classiera');
									echo $freeDays;
								}else{
									?>
									<?php esc_html_e('For', 'classiera') ?>
						...
						<form method="post" class="planForm">
							...
							if($free_plans == 1){
								...
								?>
							<a class="btn btn-primary round btn-md btn-style-two" href="<?php echo $link; ?>">
								...
								?>
							<a rel="nofollow" href="#" data-quantity="1" data-product_id="<?php echo $wooID; ?>" data-product_sku="" class="classiera_plan_add_to_cart btn btn-primary round btn-md btn-style-two button">
							<span><i class="fa fa-plus"></i></span>
							<?php esc_html_e( 'Purchase Now', 'classiera' ); ?>
								...
								<?php
									...
									?>
									<a rel="nofollow" href="<?php echo $login; ?>" class="btn btn-primary round btn-md btn-style-two button">
									<span><i class="fa fa-plus"></i></span>
									<?php esc_html_e( 'Purchase Now', 'classiera' ); ?>
									</a>
									<?php
						...
						<div class="viewcart text-center">							
							<a class="btn btn-primary round btn-md btn-style-two" href="<?php echo $classieraCartURL; ?>">
							<span><i class="fa fa-plus"></i></span>
