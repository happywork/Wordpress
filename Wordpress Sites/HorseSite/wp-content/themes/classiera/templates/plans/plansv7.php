					...
					<div class="pricing-plan-box <?php if($popular_plan == 'true'){echo "popular";} ?>">
						...
						<form method="post" class="planForm">
							...
							if($free_plans == 1){
								...
								?>
							<a class="btn btn-primary outline radius btn-style-six" href="<?php echo $link; ?>">
								...
								?>
							<a rel="nofollow" href="#" data-quantity="1" data-product_id="<?php echo $wooID; ?>" data-product_sku="" class="classiera_plan_add_to_cart btn btn-primary outline radius btn-style-six">
							<?php esc_html_e( 'Purchase Now', 'classiera' ); ?>
							</a>
								<?php
								}else{
									?>
									<a rel="nofollow" href="<?php echo $login; ?>" class="btn btn-primary outline radius btn-style-six">
									<?php esc_html_e( 'Purchase Now', 'classiera' ); ?>
									</a>
									<?php
								}
						...
						<div class="viewcart pricing-plan-button text-center">
							<a class="btn btn-primary outline radius btn-style-six" href="<?php echo $classieraCartURL; ?>">
