	...
	<div style="overflow: hidden;">
		...
		<div class="navText">
			<a class="prev btn btn-primary round outline btn-style-six">
				<i class="icon-left fa fa-long-arrow-<?php if(is_rtl()){echo "right";}else{echo "left";}?>"></i>
				<?php esc_html_e( 'Previous', 'classiera' ); ?>
			</a>
            <a class="next btn btn-primary round outline btn-style-six">
				<?php esc_html_e( 'Next', 'classiera' ); ?>
				<i class="icon-right fa fa-long-arrow-<?php if(is_rtl()){echo "left";}else{echo "right";}?>"></i>
			</a>
		</div>
	</div>
</section>