...
<section class="topBar <?php echo $classieraNavClass; ?> hidden-xs">
	<div class="<?php echo $classieraContainer; ?>">
		<div class="<?php echo $classieraRow; ?>">
			<div class="<?php echo $classieraColLG; ?> <?php echo $classieraColMD; ?> <?php echo $classieraColSM; ?>">
			...
			<div class="<?php echo $classieraColLG2; ?> <?php echo $classieraColMD2; ?> <?php echo $classieraColSM2; ?>">
			<?php if($classieraNavStyle == 1){?>	
			...
			<?php }elseif($classieraNavStyle == 2){?>
				<div class="topBar-v2-icons text-right flip">
					...
					<span class="top-icons">
						...
						<a href="<?php echo $classieraFacebook; ?>" class="social-icon-v2 rounded">
							<i class="fa fa-facebook"></i>
						</a>
						<?php } ?>
						<?php if(!empty($classieraTwitter)){?>
						<a href="<?php echo $classieraTwitter; ?>" class="social-icon-v2 rounded">
							<i class="fa fa-twitter"></i>
						</a>
						<?php } ?>
						<?php if(!empty($classieraInstagram)){?>
						<a href="<?php echo $classieraInstagram; ?>" class="social-icon-v2 rounded">
